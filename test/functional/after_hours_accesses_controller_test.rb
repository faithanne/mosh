...
class AfterHoursAccessesControllerTest < ActionController::TestCase
  ...
  test "should create after_hours_access" do
    assert_difference('AfterHoursAccess.count') do
      post :create, after_hours_access: { first_name: @after_hours_access.first_name, last_name: @after_hours_access.last_name, location_id: @after_hours_access.location_id, semester_id: @after_hours_access.semester_id, user_id: @after_hours_access.user_id }
    end
  ...
  test "should update after_hours_access" do
    put :update, id: @after_hours_access, after_hours_access: { first_name: @after_hours_access.first_name, last_name: @after_hours_access.last_name, location_id: @after_hours_access.location_id, semester_id: @after_hours_access.semester_id, user_id: @after_hours_access.user_id }
    assert_redirected_to after_hours_access_path(assigns(:after_hours_access))
  end
