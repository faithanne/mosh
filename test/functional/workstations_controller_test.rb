...
class WorkstationsControllerTest < ActionController::TestCase
  ...
  test "should create workstation" do
    assert_difference('Workstation.count') do
      post :create, workstation: { location_id: @workstation.location_id, number: @workstation.number, workstation_type_id: @workstation.workstation_type_id }
    end
  ...
  test "should update workstation" do
    put :update, id: @workstation, workstation: { location_id: @workstation.location_id, number: @workstation.number, workstation_type_id: @workstation.workstation_type_id }
    assert_redirected_to workstation_path(assigns(:workstation))
  end
